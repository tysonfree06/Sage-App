// //bk subscription.dart (IAP included)
// import 'dart:async';
// import 'dart:io';
...
//         if (mounted) {
//           context.flushBarErrorMessage(message: 'Errory verifying purchase...');
//         }
//       }
//     }
//   }
...
//                 onPressed: () async {
//                   await handleSubscribeButton(getPaymentIntent);
//                 },
...
//     Future<void> Function() getPaymentIntent,
//   ) async {
...
//       ProductDetails product = _subscriptions.firstWhere(
...
//         product = _subscriptions.firstWhere(
